    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-gray-700 dark:text-white/90 text-center -mt-4">Ravi de vous revoir, votre espace est prêt !</p>
                ...
                {message && (
                    <div className={`fixed w-full max-w-[85%] top-36 md:top-20 left-1/2 transform -translate-x-1/2 transition-all ease-out py-2 px-4 border text-center text-base rounded-lg ${isSuccess ? 'text-green-600 bg-green-100' : 'text-red-600 bg-red-100'}`}>
                        {message}
                    </div>
                )}
